...
function Tickets({ConsultarTicket, anularTicket, pagarTicket, RepetirTicket,btnRepeat, actualizar}) {
                        ...
                        <tbody>
                           {
                                ticketsUser.map((valor, index)=>{
                                    ...
                                    if (valor.cerrado == 1 && premio_total == 0 && segundos_transcurridos > tiempo) 
                                    {
