...
function Header({myticketConsulta, setMyticketConsulta, SeleccionarTicket}) {
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <ul className="navbar-nav ">
            <li className="nav-item dropdown ">
              <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"id="navbarDropdownMenuLink">
                <Saldouser/>
              </a>
