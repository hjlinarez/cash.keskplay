...
function PagarTicket({ idticket, setIdticketPagar, setProcesando, setActualizarTickets }) {
    ...
    useEffect(() => {    
        if (idticket > 0) { // ✅ Verificación correcta
            ...
            {                
                ...
                fetch(urlApi + "/gallos/ticket/" + idticket, {
                method: "GET", // or 'PUT'
                headers: {
    ...
    const ProcesarPago = ()=>{
        ...
        if (localStorage.getItem("token")){
            setProcesando(true);
            let token = "Bearer " + localStorage.getItem("token");      
            let url =  urlApi+'/gallos/pagarticket';
                ...
                <div className="modal-dialog modal-lg modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Pagar / Ruleta #{myticket.idticket}</h1>
